...
def buildmuscle(event):
    ...
    if sex == "Male":
        bmr = round(10 * float(weight) + 6.25 * int(height) - 5 * int(age) + 5)
        ...
        if activity in activity_calories:
            calorie = round(((bmr * activity_calories[activity] + 500) * 0.3) / 4)
            result_result.configure(text=calorie, fg="Green")

    elif sex == "Female":

        bmr = round(10 * float(weight) + 6.25 * int(height) - 5 * int(age) - 161)
...
def loseweight(event):
    ...
    if sex == "Male":
        ...
        if activity in activity_calories:
            calorie = round(((bmr * activity_calories[activity] * 0.8) * 0.4) / 4)
            result_result.configure(text=calorie, fg="Green")
...
def maintainweight(event):
    ...
    if sex == "Male":
        ...
        if activity in activity_calories:
            calorie = round((bmr * activity_calories[activity] * 0.3) / 4)
